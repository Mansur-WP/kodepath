...
export const languages: Language[] = [
  {
    ...
    difficulty: "Beginner",
    categories: ["Web Dev", "AI/ML", "Data Science", "Backend", "Cybersecurity", "IT"],
  ...
  },
  {
    ...
    difficulty: "Advanced",
    categories: ["Systems", "Embedded", "Cybersecurity"],
  ...
  },
  {
    ...
    difficulty: "Advanced",
    categories: ["Game Dev", "Systems", "Performance", "Cybersecurity"],
  ...
  },
  {
    ...
    creator: "Google",
    difficulty: "Intermediate",
    categories: ["Backend", "Cloud", "Systems", "Cybersecurity", "IT"],
  ...
  },
  {
    ...
    difficulty: "Advanced",
    categories: ["Systems", "Backend", "WebAssembly", "Cybersecurity"],
